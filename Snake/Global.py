...
max_fps:int = 120
d_size:int = 60 #default size 15 - (screen_w + screen_h) * 0.04
...
emptybutton_small = pygame.transform.scale(get_sprite(buttons, 0, 196, 17, 14), (17 * buttonscale, 14 * buttonscale))
